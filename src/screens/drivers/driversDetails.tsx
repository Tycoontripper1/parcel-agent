...
const DriversDetails = ({ route}: Props) => {
  ...
  return (
    <CustomView style={{paddingVertical: RFValue(10)}}>
      ...
      <View style={{paddingHorizontal: RFValue(10)}}><HomeHeader type="Stack" title="Driver’s Profile" /></View>
      ...
      <View
        ...
        >
          ...
          <Image
            ...
            resizeMode="cover"
          />
          <TouchableOpacity style={{backgroundColor:"",padding:RFValue(4), borderRadius:RFValue(6)}}>
        ...
        {/* {driver.parcelImages &&
        driver.parcelImages.filter((photo) => photo).length > 0 ? (
          <View style={{paddingVertical: RFValue(10), padding: RFValue(16)}}>
            <Text style={styles.counter}>
              {driver.parcelImages.filter((photo) => photo !== null).length}
              /4 photos
            </Text>
            <View style={styles.photoGrid}>
              {driver.parcelImages.map((photo, index) => (
