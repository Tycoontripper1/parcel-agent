...
const WithdrawToWalletScreen = ({ navigation }: Props) => {
  ...
  const handleNext = () => {
    navigation.navigate('InputWithdrawAmountWalletScreen', {
      accountNumber,
  ...
  return (
    <CustomView style={{ flex: 1, backgroundColor: "#fff" }}>
      {isFetching && <Spinner />}
      <View style={{ paddingHorizontal: RFValue(16) , paddingVertical:RFValue(8)}}>
        ...
        >
          ...
          <View style={$buttonsContainer}>
            <ButtonHome
              ...
              title={"Next"}
              style={{ height: 45 }}
              disabled={isFetching || !accountNumber}
            />
          </View>
        </View>
      </KeyboardAvoidingView>
...
export default WithdrawToWalletScreen;
