...
type Props = NativeStackScreenProps<ReportStackList, "AssignParcelDetails">;

// OR if you only need the `route` prop:
interface RouteProps {
  route: RouteProp<ReportStackList, "AssignParcelDetails">;
}
const AssignParcelDetails = ({ route, navigation }: Props) => {
...
export default AssignParcelDetails;
