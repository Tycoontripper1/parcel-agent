...
const OverdueParcelHistory = ({ navigation }: Props) => {
...
const transactions: Transaction[] = [
    ...
    return (
      ...
      <HomeHeader type='Stack' title='Overdue Parcels' />
            ...
            renderItem={({ item: properDate }) => (
              <View style={styles.section}>
                ...
                {groupedTransactions[properDate]?.map((item, index) => (
                  <TouchableOpacity key={index} style={styles.shipmentRow} onPress={()=> navigation.navigate('OverdueParcelDetails',{id: item.id} )}>
...
export default OverdueParcelHistory;
