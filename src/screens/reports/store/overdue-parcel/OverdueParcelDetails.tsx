...
type Props = NativeStackScreenProps<ReportStackList, "OverdueParcelDetails">;

// OR if you only need the `route` prop:
interface RouteProps {
  route: RouteProp<ReportStackList, "OverdueParcelDetails">;
}
const OverdueParcelDetails = ({ route, navigation }: Props) => {
      ...
      <KeyBoardView padded={false}>
        <View
         ...
         <View style={{   flexDirection: 'row',
                ...
                gap: 6}}>
         <View
            style={{backgroundColor: '#FEDEDC', padding: 4, borderRadius: 8,}}>
            <Text color='#F04438' size={10}>Overdue</Text>
          </View>
         </View>
        </View>
        <View
...
export default OverdueParcelDetails;
