...
type Props = NativeStackScreenProps<ReportStackList, "UnPaidParcelDetails">;

// OR if you only need the `route` prop:
interface RouteProps {
  route: RouteProp<ReportStackList, "UnPaidParcelDetails">;
}
const UnPaidParcelDetails = ({ route, navigation }: Props) => {
      ...
      <KeyBoardView padded={false}>
        <View
         ...
         <View
            ...
            <Text color='#7A5AF8' size={10}>Unpaid</Text>
          </View>
         </View>
        </View>
        <View
...
export default UnPaidParcelDetails;
