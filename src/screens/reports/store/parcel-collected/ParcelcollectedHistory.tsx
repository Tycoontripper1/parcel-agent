...
const ParcelCollectedHistory = ({ navigation }: Props) => {
...
const transactions: Transaction[] = [
    ...
    return (
      ...
      <HomeHeader type='Stack' title='Parcels Collected' />
            ...
            renderItem={({ item: properDate }) => (
              <View style={styles.section}>
                ...
                {groupedTransactions[properDate]?.map((item, index) => (
                  <TouchableOpacity key={index} style={styles.shipmentRow} onPress={()=> navigation.navigate('ParcelcollectedDetails',{id: item.id} )}>
...
export default ParcelCollectedHistory;
