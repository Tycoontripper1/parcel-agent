...
type Props = NativeStackScreenProps<ReportStackList, "ParcelcollectedDetails">;

// OR if you only need the `route` prop:
interface RouteProps {
  route: RouteProp<ReportStackList, "ParcelcollectedDetails">;
}
const ParcelcollectedDetails = ({ route, navigation }: Props) => {
...
export default ParcelcollectedDetails;
